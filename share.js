(function(window) {
  ...
  Share.info = {
      id: '[id:123456]',
      name: 'Leson',
      head_image: "http://192.168.0.78:8081/img/app-download-ic.72f43025.png",
      introduce: '我们致力于打造公平、安全、透明的交易环境，给用户带来极致的交易体验'
  };
  /**
   * 更新分享服务
   */
  ...
  function shareMessage(s, ex) {
      ...
      msg.title = "我在xxxx等你——" + Share.info.name;
  ...
  if(window.plus) {  
    ...
    document.addEventListener('plusready', getSerivces, false);  
  }
})(window)